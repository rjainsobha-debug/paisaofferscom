...
function normalizeSheetDeal(row) {
  ...
  return {
    ...
    oldPrice: parseFloat(row.oldPrice || row.mrp || row.original_price || row.OldPrice || 0) || 0,
    newPrice: parseFloat(row.newPrice || row.price || row.offer_price || row.NewPrice || 0) || 0,
